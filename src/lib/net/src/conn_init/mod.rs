...
/// Protocol version supported by this server implementation (Minecraft 1.21.9).
/// Used for rejecting clients with mismatched versions during handshake.
pub const PROTOCOL_VERSION_1_21_9: i32 = 773;
...
pub async fn handle_handshake(
    ...
    if hs_packet.protocol_version.0 != PROTOCOL_VERSION_1_21_9 {
        trace!(
            "Protocol version mismatch: {} != {}",
            hs_packet.protocol_version.0,
            PROTOCOL_VERSION_1_21_9
        );
...
/// Please use Minecraft version 1.21.9 to connect to this server.
/// Server Version: 773 | Your Version: <client_version>
/// ```
///
...
fn get_mismatched_version_message(client_version: i32) -> TextComponent {
    ComponentBuilder::text("")
        ...
        .extra(ComponentBuilder::text(PROTOCOL_VERSION_1_21_9.to_string()).color(NamedColor::Aqua))
